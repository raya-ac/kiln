...
struct FileTreeView: View {
    ...
    private func languageForFile(_ path: String) -> String {
        ...
        // New-wave / experimental systems
        case "hare", "ha": return "hare"
        case "pony": return "pony"
        case "jakt": return "jakt"
        case "mojo": return "mojo"
        case "carbon": return "carbon"
        case "chapel", "chpl": return "chapel"
        case "vale": return "vale"
        case "austral": return "austral"
        case "virgil": return "virgil"
        case "cone": return "cone"
        case "beef": return "beef"
        case "roc": return "roc"
        case "wren": return "wren"
        case "squirrel", "nut": return "squirrel"
        case "haxe", "hx": return "haxe"
        case "gdscript", "gd": return "gdscript"
        case "angelscript", "as2": return "angelscript"
        case "unrealscript", "uc": return "unrealscript"
        // Historical / obscure
        case "ada", "adb", "ads": return "ada"
        case "cob", "cbl", "cobol", "cpy": return "cobol"
        case "pli", "pl1": return "pli"
        case "mumps", "mps": return "mumps"
        case "bcpl": return "bcpl"
        case "simula": return "simula"
        case "forth", "fth", "4th": return "forth"
        case "red": return "red"
        case "rebol", "r3": return "rebol"
        ...
        case "rexx", "rex": return "rexx"
        case "awk", "gawk": return "awk"
        case "sed": return "sed"
        // Esoteric
        case "bf", "brainfuck": return "brainfuck"
        case "ws": return "whitespace"
        case "befunge", "bf93": return "befunge"
        case "lolcode", "lol": return "lolcode"
        case "piet": return "piet"
        case "intercal": return "intercal"
        case "malbolge": return "malbolge"
        // Theorem provers / proof assistants
        case "coq", "v.coq": return "coq"
        case "lean": return "lean"
        case "agda": return "agda"
        case "idris", "idr": return "idris"
        case "isabelle", "thy": return "isabelle"
        case "fstar", "fst": return "fstar"
        case "dafny", "dfy": return "dafny"
        case "tla": return "tla"
        // ML family extras
        case "sml": return "sml"
        case "reason", "re", "rei": return "reason"
        case "rescript", "res", "resi": return "rescript"
        case "purescript", "purs": return "purescript"
        case "mirah": return "mirah"
        // Lisp family
        case "lisp", "lsp", "cl": return "commonlisp"
        case "fennel", "fnl": return "fennel"
        case "janet": return "janet"
        case "hy": return "hy"
        case "guile": return "scheme"
        case "carp": return "carp"
        // Logic / declarative
        case "prolog", "pro": return "prolog"
        case "mercury": return "mercury"
        case "datalog": return "datalog"
        case "minizinc", "mzn": return "minizinc"
        ...
        case "ion": return "shell"
        // Hardware description
        case "vhd", "vhdl": return "vhdl"
        case "sv", "svh", "v.sv", "verilog": return "systemverilog"
        case "scala.chisel", "chisel": return "scala"
        case "bsv": return "bluespec"
        // Assembly / low-level
        case "asm", "s", "nasm": return "asm"
        case "wat", "wast": return "wat"
        case "llvm", "ll": return "llvm"
        case "ptx": return "ptx"
        // Shaders / GPU
        case "glsl", "vert", "frag", "geom", "comp", "tesc", "tese": return "glsl"
        case "hlsl", "fx", "fxh": return "hlsl"
        case "metal": return "metal"
        case "cu", "cuh": return "cuda"
        case "cl.opencl": return "opencl"
        // Data description / IDL
        case "capnp": return "capnp"
        case "fbs": return "flatbuffers"
        case "avdl", "avsc": return "avro"
        case "smithy": return "smithy"
        case "cddl": return "cddl"
        case "asn1", "asn": return "asn1"
        // Config / infra
        case "nginx": return "nginx"
        case "apache": return "apache"
        case "caddy", "caddyfile": return "caddy"
        case "service", "socket", "timer", "target", "mount", "path", "automount", "slice", "scope": return "systemd"
        case "env": return "dotenv"
        case "properties": return "properties"
        case "editorconfig": return "editorconfig"
        case "gitignore", "dockerignore": return "gitignore"
        case "robot": return "robot"
        case "just", "justfile": return "just"
        case "bazel", "bzl", "starlark", "star": return "starlark"
        case "ninja": return "ninja"
        case "meson", "wrap": return "meson"
        // Templates
        case "j2", "jinja", "jinja2": return "jinja"
        case "ejs": return "ejs"
        case "erb": return "erb"
        ...
        case "cdc": return "cadence"
        case "clar": return "clarity"
        case "ride": return "ride"
        case "scrypt": return "scrypt"
        case "fe": return "fe"
        case "huff": return "huff"
        case "yul": return "yul"
        case "michelson": return "michelson"
        case "teal": return "teal"
        // Stats / scientific
        case "stata", "do": return "stata"
        case "sas": return "sas"
        case "wl", "wls", "nb": return "wolfram"
        case "mpl": return "maple"
        case "gap": return "gap"
        case "max": return "maxima"
        case "sage": return "python"
        // Docs / markup
        ...
        // Query / DB
        case "cypher", "cyp": return "cypher"
        case "sparql", "rq": return "sparql"
        case "partiql": return "partiql"
        case "kql": return "kql"
        case "spl": return "splunk"
        // Pine / trading
        case "pine": return "pinescript"
        case "mq4", "mq5": return "mql"
        case "ninjascript": return "csharp"
        // Game engines
